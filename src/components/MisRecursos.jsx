...
const MisRecursos = () => {
  ...
  const handleChangeRecurso = (e) => {
    ...
    if ((name === "id_categoria" || name === "id_asignatura") ? parseInt(value) : value  ) {
        ...
        <div className="titulo-recursos-con-boton">
          <div>
            ...
            <p className="mensaje-suspension">
              ⚠ Los recursos con más de <strong>5 reportes</strong> serán{" "}
        ...
        <div className="controles-recursos">
          ...
          <div className="filtros-avanzados">
            <div className="filtro-item">
              ...
              {cargandoAsignaturas && (
                <small className="cargando-asignaturas">
        ...
        <table className="tabla-recursos">
          ...
          <tbody>
            {elementosActuales.map((recurso) => {
              ...
              const estaActivo =
                recurso.activo !== undefined ? recurso.activo === 1 : true;

              return (
                <tr
                  key={recurso.id_recurso}
                  className={`fila-recurso ${
                    !estaActivo ? "recurso-inactivo" : ""
                  }`}
                >
            ...
            <form onSubmit={handleSubmitRecurso}>
              <div className="modal-cuerpo-recursos">
                ...
                <div className="campo-formulario-recursos">
                  ...
                  {cargandoAsignaturas && (
                    <small className="cargando-asignaturas-modal">
                      Cargando asignaturas de tu carrera...
                    </small>
                  )}
                  {userData?.carrera_nombre && (
                    <small className="info-carrera-filtro">
                      Mostrando asignaturas de:{" "}
                      <strong>{userData.carrera_nombre}</strong>
                    </small>
                  )}
                </div>
                    ...
                    {esCategoriaLinks() ? (
                      <div className="campo-url-manual">
                        ...
                        <div className="info-url">
                          <small>
                            Ingresa la URL completa del recurso web (YouTube,
                            artículos, sitios educativos, etc.)
                          </small>
                        </div>
                      </div>
                    ) : (
                    ...
                    >
                      {esCategoriaLinks() ? (
                        <>
                          ...
                          <span>
                            Estás creando un <strong>enlace web</strong>. Solo
                            necesitas ingresar la URL.
                          </span>
                        </>
                      ) : (
                        <>
                          ...
                          <span>
                            ...
                            .
                            {recursoActual.id_categoria === 1 &&
                              " El archivo se subirá a Cloudinary."}
                            {recursoActual.id_categoria === 3 &&
                              " El video se subirá a Cloudinary."}
                            {recursoActual.id_categoria === 2 &&
                              " El archivo se subirá a Cloudinary."}
                          </span>
                        </>
                      )}
            ...
            <div className="modal-cuerpo-recursos">
              ...
              <div className="info-eliminar-detalle">
                <p>
                  ...
                  {getNombreAsignatura(recursoAEliminar?.id_asignatura)}
                </p>
                <p>
                  <strong>Categoría:</strong>{" "}
                  {getNombreCategoria(recursoAEliminar?.id_categoria)}
                </p>
                <p>
                ...
                <p>
                  <strong>Fecha:</strong>{" "}
                  {new Date(recursoAEliminar?.fecha_subida).toLocaleDateString(
                    "es-ES"
                  )}
                </p>
              </div>
              ...
              {recursoAEliminar?.contador_reportes > 0 && (
                <div className="alerta-reportes">
                  ⚠️ Este recurso tiene {recursoAEliminar.contador_reportes}{" "}
                  reporte(s)
                </div>
              )}
            </div>
