...
const TipoCarreras = () => {
  ...
  if (!tiposCarrera.length && !cargando)
    return (
      <div className="estado-inicial">
        ...
        <button className="boton-nuevo-tipo-carrera" onClick={handleNuevoTipoCarrera}>
          + Crear Primer Tipo
        </button>
      </div>
    );
  ...
  return (
    <div className="contenedor-tipo-carreras tipo-carreras-pro">
      {mensaje && (
      ...
      <div className="cabecera-tipo-carreras tipo-carreras-header-pro">
        <div className="titulo-tipo-carreras-con-boton tipo-carreras-header-minimal">
          <div className="tipo-carreras-header-info">
            <div className="tipo-carreras-badge-superior">
              <span>Clasificación académica activa</span>
            </div>
          </div>
        ...
        <div className="controles-tipo-carreras">
          ...
          <div className="controles-paginacion-superior">
            ...
            <div className="info-cantidad-tipo-carreras">
              {tiposCarreraFiltrados.length}{" "}
              {tiposCarreraFiltrados.length === 1 ? "tipo encontrado" : "tipos encontrados"}
            </div>
          </div>
        </div>
      </div>
              ...
              return (
                <tr key={tipo.id_tipo_carrera} className="fila-tipo-carrera">
                  <td className="celda-id-tipo-carrera">
                    <div
                      className="badge-id-tipo-carrera"
                      style={{
